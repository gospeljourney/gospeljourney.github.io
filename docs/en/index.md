---
layout: home
description: An open learning journey that helps you learn the gospel, understand it, and live it out.

hero:
  name: Gospel Journey
  text: A journey to learn, understand, and live out the gospel
  tagline: An Open Journey Through the Gospel
  image:
    src: /brand/symbol.svg
    alt: Gospel Journey symbol
  actions:
    - theme: brand
